describe "main" do
  before(:all) do
    ...
    # Will be located at: /tmp/terraspace/test-harnesses/azure/acr-harness
    terraspace.build_test_harness(
      name: "azure/acr-harness",
      modules: {azure/acr: mod_path},
      # See: https://terraspace.cloud/docs/testing/test-harness/
      # config: "spec/fixtures/config",
      # tfvars: {example: "spec/fixtures/tfvars/test.tfvars"},
    )
    terraspace.up("azure/acr")
  end
  after(:all) do
    terraspace.down("azure/acr")
  end
  ...
  it "successful deploy" do
    ...
    # output_value = terraspace.output("azure/acr", "name")
